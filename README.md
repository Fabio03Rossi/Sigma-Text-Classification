...
df_training = pd.read_excel("docs/training_docs/DummyClosingNotes-training.xlsx") # Path del file Excel
df_validation = pd.read_excel("docs/training_docs/DummyClosingNotes-validation.xlsx")
df_test = pd.read_excel("docs/training_docs/DummyClosingNotes-test.xlsx")
